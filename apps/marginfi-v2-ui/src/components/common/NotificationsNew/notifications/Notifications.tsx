...
export const NotificationsBase = (
  ...
  return (
    <ExternalPropsProvider props={normalizedExtProps}>
      <div className={clsx("dt-flex dt-h-full dt-w-full dt-flex-col", ClassTokens.Background.Primary)}>
        <WalletStatesWrapper
          header={
            <Header
              title="Notifications"
...
export const Notifications = memo(function Notifications(props: NotificationsProps) {
  return (
