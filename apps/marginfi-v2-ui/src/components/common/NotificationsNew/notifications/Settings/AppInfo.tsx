...
export const AppInfo = () => {
  return (
    <div className="dt-flex dt-flex-col dt-items-center dt-justify-center dt-gap-2.5">
      ...
      >
        Powered By{" "}
        <a href="https://dialect.to" target="_blank" rel="noreferrer" className="hover:dt-text-inherit">
          <DialectLogo className="-dt-mt-[1px] dt-ml-[3px]" />
        </a>
      </div>

      <div className="dt-flex dt-items-center dt-justify-center">
        <span className={clsx("dt-text-caption", ClassTokens.Text.Tertiary)}></span>
      </div>
    </div>
  );
};
